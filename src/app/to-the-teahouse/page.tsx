...
function ToTheTeahouse() {
    ...
    return (
        <div className=" bg-black h-full place-content-center w-full">
            ...
            <video autoPlay className="object-cover h-full m-auto w-full border-amber-50" onEnded={() => redirect('/teahouse', RedirectType.replace)}>
                <source src={"/videos/transition_to_teahouse.mp4"} type="video/mp4" />
